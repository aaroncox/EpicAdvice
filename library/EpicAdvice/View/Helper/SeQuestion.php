<?php
/**
 * EpicAdvice_View_Helper_SeQuestion
 *
 * undocumented class
 * 
 ...
 **/
class EpicAdvice_View_Helper_SeQuestion extends MW_View_Helper_HtmlTag
{
	public function seQuestion($question) {
		...
		$link = $this->view->seQuestionLink($question); 
		...
		return $this->htmlTag('div', array('class' => 'question-summary narrow'), 
...
} // END class EpicAdvice_View_Helper_SeQuestion